...
繝ｪ繝輔ぃ繧ｯ繧ｿ繝ｪ繝ｳ繧ｰ繧ｻ繝・す繝ｧ繝ｳ繧貞ｮ御ｺ・＠縲∵怙邨ょ刀雉ｪ繧ｲ繝ｼ繝医ｒ螳溯｡後＠縲∝ｮ御ｺ・ｒ險倬鹸縺吶ｋ縲・
## Usage
...
**Arguments:**
- `--partial`: 驛ｨ蛻・噪縺ｪ謌仙粥縺ｧ螳御ｺ・ｼ井ｸ驛ｨ繝舌ャ繝∵悴螳御ｺ・ｼ・- `--skip-verify`: 譛邨ょ刀雉ｪ讀懆ｨｼ繧偵せ繧ｭ繝・・

## Prerequisites

- 繧｢繧ｯ繝・ぅ繝悶↑繝ｪ繝輔ぃ繧ｯ繧ｿ繝ｪ繝ｳ繧ｰ繧ｻ繝・す繝ｧ繝ｳ縺悟ｭ伜惠縺吶ｋ縺薙→
- 蟆代↑縺上→繧・縺､縺ｮ繝舌ャ繝√′螳御ｺ・＠縺ｦ縺・ｋ縺薙→・・--partial`菴ｿ逕ｨ譎ゅｒ髯､縺擾ｼ・
## Execution Steps
