...
### 朝のレビュー
`.kiro/ai-coordination/workflow/review/ralph/NIGHTLY_REPORT_20260104.md`
```
...
### 推奨アクション
1. `.kiro/ralph/logs/20260104-blocked.md` を確認
2. 問題を手動で調査・修正
...
- `.kiro/ralph/.lock` - 実行ロック
- `.kiro/ralph/recovery/checkpoints/latest.json` - 最新チェックポイント
