...
---
description: Manage .sd/steering/ as persistent project knowledge
allowed-tools: Read, Task, Glob
---

# SD Steering Management

## Mode Detection

**Perform detection before invoking SubAgent**:

Check `.sd/steering/` status:
...
- .sd/steering/*.md (if sync mode)
- .sd/settings/templates/steering/*.md
- .sd/settings/rules/steering-principles.md
...
- All `.sd/steering/*.md` loaded as project memory
