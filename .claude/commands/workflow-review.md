...
保存先: `.kiro/ai-coordination/workflow/spec/{案件ID}/REVIEW_REQUEST_{タスク番号}.md`
...
### Step 4: Codex CLI実行
```bash
REVIEW_CONTENT=$(cat .kiro/ai-coordination/workflow/spec/{案件ID}/REVIEW_REQUEST_{タスク番号}.md)
